...
- **Freyja.txt** — the full character profile: modern-day bio, personality, archetype, relationship framing, example conversations, starter dialogs, and the system prompt.
...
- `memories/` is a local-only test scaffold for an experimental memory system and is intentionally not tracked in git.
